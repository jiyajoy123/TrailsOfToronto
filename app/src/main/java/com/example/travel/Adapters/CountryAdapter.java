            ...
            favBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (countryItem.getFavStatus().equals("0")) {
                        ...
                        travelDB.insertIntoTheDatabase(countryItem.getTitle(), countryItem.getImageResourse(), countryItem.getKey_id(), countryItem.getFavStatus(), countryItem.getCountrydesc());
